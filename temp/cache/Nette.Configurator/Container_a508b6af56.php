...
class Container_a508b6af56 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'C:\Users\ASG\Documents\nette-blog\app',
			'wwwDir' => 'C:\Users\ASG\Documents\nette-blog\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\Users\ASG\Documents\nette-blog\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\ASG\Documents\nette-blog\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\ASG\Documents\nette-blog\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\ASG\Documents\nette-blog\app/../temp/cache',
	...
	{
		return new Container_a508b6af56_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_a508b6af56_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_a508b6af56 $container)
	{
	...
	public function create(): Latte\Engine
	{
		...
		$service->setTempDirectory('C:\Users\ASG\Documents\nette-blog\app/../temp/cache/latte');
