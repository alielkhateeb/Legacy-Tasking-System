<?php
// source: C:\Users\ASG\Documents\Legacy-Tasking-System\app/config/config.neon 
// source: C:\Users\ASG\Documents\Legacy-Tasking-System\app/config/config.local.neon 

class Container_3b78f519ff extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Object' => [1 => ['27_App_Model_Task']],
			'App\Model\Task' => [1 => ['27_App_Model_Task']],
		...
		'services' => [
			...
			'27_App_Model_Task' => 'App\Model\Task',
	...
	{
		parent::__construct([
			'appDir' => 'C:\Users\ASG\Documents\Legacy-Tasking-System\app',
			'wwwDir' => 'C:\Users\ASG\Documents\Legacy-Tasking-System\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\Users\ASG\Documents\Legacy-Tasking-System\app/../temp',
		]);
	}
	 ...
	 */
	public function createService__27_App_Model_Task()
	{
		$service = new App\Model\Task($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('27_App_Model_Task'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\ASG\Documents\Legacy-Tasking-System\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\ASG\Documents\Legacy-Tasking-System\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\ASG\Documents\Legacy-Tasking-System\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=localhost', 'root',
			'root', ['lazy' => TRUE]);
	...
	{
		return new Container_3b78f519ff_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_3b78f519ff_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_3b78f519ff $container)
	{
	...
	public function create(): Latte\Engine
	{
		...
		$service->setTempDirectory('C:\Users\ASG\Documents\Legacy-Tasking-System\app/../temp/cache/latte');
